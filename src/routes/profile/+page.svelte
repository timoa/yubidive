...
<div class="min-h-screen bg-gray-50 py-12 sm:px-6 lg:px-8">
  <div class="max-w-4xl mx-auto">
    <h1 class="text-3xl font-bold mb-8">{$_('profile.editProfile')}</h1>
    ...
    <form class="space-y-8" on:submit|preventDefault={handleSubmit}>
      <div class="bg-white shadow rounded-lg">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 p-8">
          ...
          <div class="space-y-6">
            <h2 class="text-xl font-semibold">{$_('profile.details')}</h2>
          ...
          <div class="space-y-6">
            <h2 class="text-xl font-semibold">{$_('profile.changePassword')}</h2>
